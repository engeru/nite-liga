...
return [
    ...
    'Inactive' => 'Inativo',
    'Invalid editable index or model form name' => 'Índice editável inválido ou nome do formulário inválido',
    ...
    'No valid editable model found' => 'Não foi encontrado um modelo editável válido',
    ...
    'The page summary displays SUM for first 3 amount columns and AVG for the last.' => 'O sumário  exibe SOMA para os valores das 3 primeiras colunas e MÉDIA para a última.',
